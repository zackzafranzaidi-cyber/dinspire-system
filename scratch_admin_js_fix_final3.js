...
for (let i = 0; i < lines.length; i++) {
    ...
    if (inLogin && lines[i] === '  btn.innerText = "Log Masuk";') {
        inLogin = false; // Next line is } which we also skip, wait.
        // Actually, we skip this line, and the next line is }. We'll just skip the next line too.
        i++; // skip }
    }
