...
const updateBarChartEnd = '  function handleLegendClick(e, legendItem, legend) {'; // the next function
    ...
    orders.forEach((o) => {
      ...
      if (idx !== -1) {
          ...
          if (window._branchData.revenue["In-Branch"]) {
             ...
             window._branchData.profit["In-Branch"][idx] += rev; // No expense for orders
          }
      }
    });
...
// Add the setBranchMetric function at the end
js += `
...
console.log("updateBarChart rewritten successfully!");
